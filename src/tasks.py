...
def automate_tests_task(agent, app_path: str, artifacts_dir: str, max_attempts: int) -> Task:
    ...
    specialist directly to obtain `recommended_start`. Refuse to continue automation until the
    plan covers every case in the chosen scenario. After every attempt, report back to AppFlow:
